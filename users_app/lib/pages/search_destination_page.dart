...
class _SearchDestinationPageState extends State<SearchDestinationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    /// GOOGLE PLACES API - AUTO COMPLETE FOR THE DESTINATION ///
    searchLocation(String locationName) async {
      if (locationName.length > 1) {
        String apiPlacesUrl =
            "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$locationName&key=$googleMapKey&components=country:lk";
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            /// DISPLAY PREDICTION RESULTS FOR THE DESTINATIONS USING THE PLACES API ///
