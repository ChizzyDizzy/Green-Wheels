...
class CommonMethods
{
  ...
  static Future<String> convertGeoGraphicCoOrdinatesIntoHumanReadableAddress(Position position, BuildContext context) async
  {
    ...
    String apiGeoCodingUrl = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=AIzaSyAbiyKH9la9WI4RjBUtY7gQldta6OUbB0Y";
 ...
 /// CALCULATING THE FARE AMOUNT IN LANKAN RUPEES ///
